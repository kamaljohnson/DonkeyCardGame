...
class TextInput():
    ...
    def update(self, events):
        ...
        for event in events:
            if event.type == pygame.KEYDOWN and self.keyUP == True:
                self.keyUP = False
        ...
        self.surface = self.font_object.render(self.baseString + self.input_string, self.antialias, self.text_color)
        return False
